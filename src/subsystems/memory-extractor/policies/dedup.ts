/**
 * Memory Extractor Subsystem — 记忆去重与升级策略
 *
 * 避免重复记忆膨胀，当新证据更强时升级旧条目。
 *
 * 策略：
 ...
 *
 * @module subsystems/memory-extractor/policies/dedup
 */

import type { MemoryStore, MemoryQuery, MemoryEntry } from '../../../harness/memory/types.js';
import type { MemoryCandidate } from '../contracts/bundle.js';
